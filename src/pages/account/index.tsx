...
function AccountPages() {
  return (
    <div className="min-h-[400px] flex justify-between bg-gray-100">
        <Sidebar />
        <div className="flex flex-col flex-1 gap-4 md:mt-4 md:mr-4 md:ml-0 ml-0">
            <div className="flex p-4 md:rounded-[10px] items-center justify-between bg-white">
                <Formik
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="bg-gray-100 rounded-[10px] border border-gray-100 md:block hidden">
